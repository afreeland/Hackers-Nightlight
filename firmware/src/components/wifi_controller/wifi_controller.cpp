...
void wifi_controller::wifictl_mgmt_ap_start(){
    ...
    .ap = {
        .ssid = {0},
        .password = {0},
        .ssid_len = strlen(BOARD_AP_SSID),
        .authmode = WIFI_AUTH_WPA2_PSK,
        .ssid_hidden = BOARD_AP_HIDDEN
    }
};

    strncpy((char *)mgmt_wifi_config.ap.ssid, BOARD_AP_SSID, sizeof(mgmt_wifi_config.ap.ssid) - 1);
    strncpy((char *)mgmt_wifi_config.ap.password, BOARD_AP_PASSWORD, sizeof(mgmt_wifi_config.ap.password) - 1);

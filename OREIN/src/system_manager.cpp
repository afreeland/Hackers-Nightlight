...
// SDA = GPIO6, SCL = GPIO7 (confirmed via continuity: pin 12 = GPIO6/SDA, pin 13 = GPIO7/SCL)
MyCustomLightOutput output_blue(6, 7, 1, 15);
MyCustomLightOutput output_green(6, 7, 2, 15);
MyCustomLightOutput output_red(6, 7, 3, 15);
MyCustomLightOutput output_cold_white(6, 7, 4, 15);
MyCustomLightOutput output_warm_white(6, 7, 5, 15);
